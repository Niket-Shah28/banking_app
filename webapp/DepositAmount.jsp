...
<div class="card-box" role="region" aria-label="Withdraw Amount">
  ...
  <form action="CustomerDepositWithdrawController?action='DEPOSIT'" method="post">
    ...
    <div class="form-group">
      ...
      <input id="amount" name="amount" type="number" step="0.01" min="0.01" class="form-control" required placeholder="Enter amount to deposit">
    </div>

    <input type="hidden" name="transactionType" value="DEPOSIT">
    <button type="submit" class="btn-primary" style="color:white;">DEPOSIT</button>
  </form>
</div>
