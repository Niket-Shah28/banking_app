...
<div class="card-box" role="region" aria-label="Make Payment">
  ...
  <form action="MakePaymentController" method="post">
...
<!-- Optional: Payment history table (same styling pattern as your other pages) -->
<div class="table-box" role="region" aria-label="Payment History">
        ...
        <table class="table w-100">
          ...
          <tbody>
            <c:forEach var="p" items="${payments}">
              <tr>
                <td class="text-start">${p.date}</td>
                <td>${p.beneficiaryAccountNumber} - ${p.beneficiaryName}</td>
